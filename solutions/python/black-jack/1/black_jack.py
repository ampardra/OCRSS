...
def value_of_card(card):
    ...
    if card in ['J', 'Q', 'K', '10']:
        ...
        return 1
    elif card in ['1', '2', '3', '4', '5', '6', '7', '8', '9']:
        return ord(card) - 48
...
def higher_card(card_one, card_two):
    ...
    big_card = card_one if value_of_card(card_one) > value_of_card(card_two) else card_two
    return big_card
...
def is_blackjack(card_one, card_two):
    ...
    if value_of_card(card_one) == 1 or value_of_card(card_two) == 1:
        if value_of_card(card_one) + value_of_card(card_two) - 1 == 10:
            return True
